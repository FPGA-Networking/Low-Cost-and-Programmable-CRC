...
run_hw_axi [create_hw_axi_txn write_txn [get_hw_axis hw_axi_1] -force -type WRITE  -address 0000_0100 -len 1 -data 0040111D ]; # XHwIcap_SetupFar(Top, Block, HClkRow,  MajorFrame, MinorFrame)
# 000000_000_1_00000_0000100010_0011101
# 6bit(0)-pad        3bit(0)-block type       1bit(1)-top      5bit(0)-row addr     10bit(34)-column addr         7bit(29)-minor addr-the third frm
# 00000000010000000001000100011101  :  0040111D
